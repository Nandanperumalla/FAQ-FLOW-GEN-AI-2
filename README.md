...
Deploy the backend folder as a Python web service (FastAPI). Note: You may want to configure persistent storage for SQLite and ChromaDB, or migrate to PostgreSQL and a managed Vector DB for production.
Deploy the frontend folder as a Next.js static site or Node server.
